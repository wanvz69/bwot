...
\n`
    txt += `> wanxyz bot ᴀᴅᴀʟᴀʜ ʙᴏᴛ ᴀᴛᴀᴜ ᴘʀᴏɢʀᴀᴍ ᴏᴛᴏᴍᴀᴛɪꜱ ʏᴀɴɢ ʙᴇʀᴊᴀʟᴀɴ ᴅɪ ᴡʜᴀᴛꜱᴀᴘᴘ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ꜰɪᴛᴜʀ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ. ꜰɪᴛᴜʀ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ᴍᴇᴍᴜɴɢᴋɪɴᴋᴀɴ ᴀᴋᴜɴ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜᴛᴀᴍᴀ ᴛᴇʀʜᴜʙᴜɴɢ ᴋᴇ ʙᴇʙᴇʀᴀᴘᴀ ᴘᴇʀᴀɴɢᴋᴀᴛ ꜱᴇᴄᴀʀᴀ ʙᴇʀꜱᴀᴍᴀᴀɴ ᴛᴀɴᴘᴀ ᴘᴇʀʟᴜ ꜱᴇʟᴀʟᴜ ᴛᴇʀʜᴜʙᴜɴɢ ᴅɪ ꜱᴍᴀʀᴛᴘʜᴏɴᴇ\n\n`
    txt += `🤖 *ʙᴏᴛ ɪɴꜰᴏ* 」\n`;

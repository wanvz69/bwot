...
const config = {
    ...
    owner: {
        name: 'wanxyz',                    // Nama owner
        number: ['6285860583601']         // Format: 628xxx (tanpa + atau 0)
    },

    session: {
        pairingNumber: '6285956071763',   // Nomor WA yang akan di-pair
        usePairingCode: true              // true = Pairing Code, false = QR Code
    },

    bot: {
        name: 'wanxyz - bot',                 // Nama bot
        version: '0.1.3',                 // Versi bot
        developer: 'wanxyz'          // Nama developer
    },
    ...
    sticker: {
        packname: 'wanxyz',             // Nama pack sticker
        author: 'Bot'                     // Author sticker
    },

    saluran: {
        id: '@newsletter',                           // ID saluran (contoh: 120363xxx@newsletter)
        name: '- Kunjungi Saluran Resmi dari wanxyz - bot',       // Nama saluran
        link: 'https://whatsapp.com/channel/0029VbBqXgrAzNboEgaI5d0j'                          // Link saluran
    },
